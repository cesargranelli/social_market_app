...
class OfferTakePicture extends StatefulWidget {
  /// Default Constructor
  const OfferTakePicture({super.key});

  @override
  State<OfferTakePicture> createState() {
    return _OfferTakePictureState();
  }
}
...
class _OfferTakePictureState extends State<OfferTakePicture>
...
class OfferTakePictureApp extends StatelessWidget {
  /// Default Constructor
  const OfferTakePictureApp({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(home: OfferTakePicture());
  }
}
